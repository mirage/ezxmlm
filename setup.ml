...
(* OASIS_START *)
(* DO NOT EDIT (digest: fa310dc927df27ba07fe4dfccbbcc696) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("ezxmlm", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("ezxmlm", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          homepage = None;
          synopsis = "A tree-based interface on top of XMLM";
          description = None;
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("xmlm", None)];
